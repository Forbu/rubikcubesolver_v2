...
We will try to optimize the reward value using gradient descend approach
"""
...
def main():
    ...
    result_generation, reward_gen = pl_model.generate_with_reward_guidance(
    ...
    for idx in range(4):
        ...
        fig, axs = plt.subplots(1, nb_futur_plot + 1, figsize=(15, 5))
